...
This remains the final CI browser entry point. Phase 13.6B Adjustment, Phase
13.6C authoritative reserve and Phase 13.7A Recovery / Time-bar maturity
acceptances are chained after the technical journey because those later journeys
intentionally mutate controlled MT ORION state and must run after all read-mostly
browser journeys.
"""
...
from recovery_timebar_maturity_e2e import main as run_recovery_timebar_maturity_acceptance
...
if __name__ == "__main__":
    ...
    run_recovery_timebar_maturity_acceptance()
