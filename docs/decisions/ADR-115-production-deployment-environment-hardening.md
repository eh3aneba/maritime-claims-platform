...
The synthetic values are not production credentials and are safe to commit. The full backend suite separately covers the detailed positive/negative matrix and preflight integration.
