...
Sprint 10D extends this decision through ADR-052. The original five-control scope is retained as the immutable `foundational_v1` profile for historical gates.
