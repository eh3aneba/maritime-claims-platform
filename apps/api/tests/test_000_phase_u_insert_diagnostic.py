        ...
        with _fake_s3() as endpoint:
            ...
            with TestingSessionLocal() as db:
                ...
                try:
                    ...
                    pytest.exit(f"PHASE_U_SERVICE_EXCEPTION={exc!r}", returncode=86)
                ...
                try:
                    ...
                    pytest.exit(f"PHASE_U_COMMIT_EXCEPTION={exc!r}", returncode=86)
    except pytest.exit.Exception:
        raise
    except BaseException as exc:
        pytest.exit(f"PHASE_U_SETUP_EXCEPTION={exc!r}", returncode=86)
    pytest.exit("PHASE_U_DIAGNOSTIC_SEQUENCE_SUCCEEDED", returncode=87)
