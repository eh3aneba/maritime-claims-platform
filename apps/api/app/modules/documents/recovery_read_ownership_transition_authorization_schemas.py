...
class RecoveryReadOwnershipTransitionAuthorizationReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryReadOwnershipTransitionAuthorizationRead(BaseModel):
...
class RecoveryReadOwnershipTransitionAuthorizationReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadOwnershipTransitionAuthorizationOperationRead(BaseModel):
    authorization: RecoveryReadOwnershipTransitionAuthorizationRead
    receipt: RecoveryReadOwnershipTransitionAuthorizationReceiptRead | None
    outcome: str
