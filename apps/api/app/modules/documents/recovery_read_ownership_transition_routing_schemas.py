...
class RecoveryReadOwnershipTransitionLeaseReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryReadOwnershipTransitionLeaseRead(BaseModel):
    ...
    read_ownership_authority_created: bool
...
class RecoveryReadOwnershipTransitionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadOwnershipTransitionRouteRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    ...
    active_durable_reauthorized_renewal_lease_id: UUID | None
    active_read_ownership_transition_lease_id: UUID | None
...
class RecoveryReadOwnershipTransitionOperationRead(BaseModel):
    lease: RecoveryReadOwnershipTransitionLeaseRead
    route: RecoveryReadOwnershipTransitionRouteRead
    receipt: RecoveryReadOwnershipTransitionReceiptRead | None
    outcome: str
