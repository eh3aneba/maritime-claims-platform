...
class RecoveryDurableReadPromotionLeaseReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryDurableReadPromotionLeaseRead(BaseModel):
...
class RecoveryDurableReadPromotionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadPathRouteRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryDurableReadPromotionOperationRead(BaseModel):
    lease: RecoveryDurableReadPromotionLeaseRead
    route: RecoveryReadPathRouteRead
    receipt: RecoveryDurableReadPromotionReceiptRead | None
    outcome: str
