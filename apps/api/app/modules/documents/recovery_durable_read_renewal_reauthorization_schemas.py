...
class RecoveryDurableReadRenewalReauthorizationReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryDurableReadRenewalReauthorizationRead(BaseModel):
...
class RecoveryDurableReadRenewalReauthorizationReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryDurableReadRenewalReauthorizationOperationRead(BaseModel):
    authorization: RecoveryDurableReadRenewalReauthorizationRead
    receipt: RecoveryDurableReadRenewalReauthorizationReceiptRead | None
    outcome: str
