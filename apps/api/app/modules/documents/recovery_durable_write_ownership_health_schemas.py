...
class RecoveryDurableWriteOwnershipHealthRequest(BaseModel):
    durable_write_ownership_lease_id: UUID
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryDurableWriteOwnershipHealthReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryDurableWriteOwnershipHealthQualificationRead(BaseModel):
    ...
    observed_durable_write_mode: str
    observed_durable_write_ownership_active: bool
...
class RecoveryDurableWriteOwnershipHealthReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryDurableWriteOwnershipHealthOperationRead(BaseModel):
    qualification: RecoveryDurableWriteOwnershipHealthQualificationRead
    receipt: RecoveryDurableWriteOwnershipHealthReceiptRead | None
    outcome: str
