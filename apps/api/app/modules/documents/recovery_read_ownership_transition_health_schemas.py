...
class RecoveryReadOwnershipTransitionHealthQualificationRequest(BaseModel):
    transition_lease_id: UUID
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryReadOwnershipTransitionHealthQualificationReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryReadOwnershipTransitionHealthQualificationRead(BaseModel):
    ...
    transition_activated_by_id: UUID
...
class RecoveryReadOwnershipTransitionHealthReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadOwnershipTransitionHealthOperationRead(BaseModel):
    qualification: RecoveryReadOwnershipTransitionHealthQualificationRead
    receipt: RecoveryReadOwnershipTransitionHealthReceiptRead | None
    outcome: str
