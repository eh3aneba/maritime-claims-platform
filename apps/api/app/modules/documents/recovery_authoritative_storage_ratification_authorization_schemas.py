...
class RecoveryAuthoritativeStorageRatificationAuthorizationRequest(BaseModel):
    health_qualification_id: UUID
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryAuthoritativeStorageRatificationAuthorizationReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryAuthoritativeStorageRatificationAuthorizationRead(BaseModel):
    ...
    phase_al_health_receipt_id: UUID
    ...
    phase_al_request_snapshot_hash: str
...
class RecoveryAuthoritativeStorageRatificationAuthorizationReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryAuthoritativeStorageRatificationAuthorizationOperationRead(BaseModel):
    authorization: RecoveryAuthoritativeStorageRatificationAuthorizationRead
    receipt: RecoveryAuthoritativeStorageRatificationAuthorizationReceiptRead | None
    outcome: str
