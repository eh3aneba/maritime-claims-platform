...
class RecoveryRoutableReadCutoverReason(BaseModel):
...
class RecoveryReadPathCutoverLeaseRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadPathCutoverReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryReadPathCutoverOperationRead(BaseModel):
    lease: RecoveryReadPathCutoverLeaseRead
    route: RecoveryReadPathRouteRead
    receipt: RecoveryReadPathCutoverReceiptRead | None
    outcome: str
