...
class RecoveryDurableReadReauthorizedRenewalLeaseReason(BaseModel):
    reason: str = Field(min_length=8, max_length=2000)


class RecoveryDurableReadReauthorizedRenewalLeaseRead(BaseModel):
...
class RecoveryDurableReadReauthorizedRenewalReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryDurableReadReauthorizedRenewalRouteRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class RecoveryDurableReadReauthorizedRenewalOperationRead(BaseModel):
    lease: RecoveryDurableReadReauthorizedRenewalLeaseRead
    route: RecoveryDurableReadReauthorizedRenewalRouteRead
    receipt: RecoveryDurableReadReauthorizedRenewalReceiptRead | None
    outcome: str
