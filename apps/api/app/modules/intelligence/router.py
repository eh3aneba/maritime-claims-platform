...
from app.modules.intelligence.schemas import AIRunResponse, DocumentExtractionResponse, DocumentIntelligenceResponse
from app.modules.intelligence.service import get_latest_ai_result
