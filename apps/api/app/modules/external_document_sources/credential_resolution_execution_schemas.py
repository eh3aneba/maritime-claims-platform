...
class ExternalDocumentSourceCredentialResolutionExecutionRequest(BaseModel):
...
class ExternalDocumentSourceCredentialResolutionExecutionRead(BaseModel):
    ...
    health_resolver_kind: str
    resolution_resolver_kind: str
    health_result_hash: str
    activation_execution_scope_hash: str
    activation_execution_request_hash: str
    activation_execution_completion_hash: str
    activation_authorization_terminal_hash: str
    request_key: str
    scope_hash: str
    request_hash: str
    status: str
...
class ExternalDocumentSourceCredentialResolutionExecutionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
