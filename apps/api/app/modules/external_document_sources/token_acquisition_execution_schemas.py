...
class ExternalDocumentSourceTokenAcquisitionExecutionRequest(BaseModel):
...
class ExternalDocumentSourceTokenAcquisitionExecutionRead(BaseModel):
    ...
    credential_resolution_scope_hash: str
    credential_resolution_request_hash: str
    credential_resolution_completion_hash: str
    token_flow_kind: str
    acquirer_kind: str
    ...
    token_endpoint_network_performed: bool
    ...
    provider_data_api_performed: bool
...
class ExternalDocumentSourceTokenAcquisitionExecutionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
