...
class ExternalDocumentSourceRemoteFileContentReadRequest(BaseModel):
...
class ExternalDocumentSourceRemoteFileContentReadRead(BaseModel):
    ...
    listing_completion_hash: str
    listing_items_hash: str
    metadata_item_hash: str
    metadata_item_version_token_hash: str | None
    declared_byte_size: int | None
    metadata_mime_type_class: str | None
...
class ExternalDocumentSourceRemoteFileContentReadReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
