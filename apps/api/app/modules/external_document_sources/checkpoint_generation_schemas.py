...
class ExternalDocumentSourceCheckpointGenerationRequest(BaseModel):
...
class ExternalDocumentSourceCheckpointGenerationRead(BaseModel):
    ...
    checkpoint_generation_advance_completed: bool
    sync_executed: bool
...
class ExternalDocumentSourceCheckpointGenerationReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
