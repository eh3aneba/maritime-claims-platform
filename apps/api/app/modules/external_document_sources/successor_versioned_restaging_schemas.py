...
class ExternalDocumentSourceSuccessorVersionedRestagingRequest(BaseModel):
...
class ExternalDocumentSourceSuccessorVersionedRestagingRead(BaseModel):
    ...
    observed_provider_item_id_hash: str
    ...
    successor_versioned_restaging_completed: bool
    ...
    @field_serializer("content_verified_at", "requested_at", "completed_at")
...
class ExternalDocumentSourceSuccessorVersionedRestagingReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
