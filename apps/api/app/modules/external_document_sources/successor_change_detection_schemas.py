...
class ExternalDocumentSourceSuccessorChangeDetectionRequest(BaseModel):
...
class ExternalDocumentSourceSuccessorChangeDetectionRead(BaseModel):
    ...
    successor_change_detection_completed: bool
...
class ExternalDocumentSourceSuccessorChangeDetectionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
