...
class ExternalDocumentSourceChangeDetectionRequest(BaseModel):
...
class ExternalDocumentSourceChangeDetectionRead(BaseModel):
    ...
    baseline_metadata_item_hash: str
...
class ExternalDocumentSourceChangeDetectionReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
