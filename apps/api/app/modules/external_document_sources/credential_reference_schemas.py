...
class ExternalDocumentSourceCredentialReferenceRequest(BaseModel):
...
class ExternalDocumentSourceCredentialReferenceDecision(BaseModel):
    model_config = ConfigDict(extra="forbid")

    reason: str = Field(min_length=8, max_length=2000)


class ExternalDocumentSourceCredentialReferenceRead(BaseModel):
    ...
    provider_kind: str
    profile_hash: str
    bootstrap_scope_hash: str
    bootstrap_request_hash: str
    bootstrap_completion_hash: str
...
class ExternalDocumentSourceCredentialReferenceReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
