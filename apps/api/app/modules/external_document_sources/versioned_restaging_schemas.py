...
class ExternalDocumentSourceVersionedRestagingRequest(BaseModel):
...
class ExternalDocumentSourceVersionedRestagingRead(BaseModel):
    ...
    original_staging_execution_id: UUID
    ...
    versioned_restaging_completed: bool
...
class ExternalDocumentSourceVersionedRestagingReceiptRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
