...
ApprovalRole = Literal["security", "privacy", "product", "operations", "risk", "claims_governance"]


class AIBroaderProductionCreate(BaseModel):
    ...
    rollout_percentage: int = Field(ge=26, le=50)
    max_claims: int = Field(ge=1, le=50)
    max_documents: int = Field(ge=1, le=150)
    ...
    confirm_separate_broader_production: bool


class AIBroaderProductionApprovalWrite(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AIBroaderProductionDecision(BaseModel):
    model_config = ConfigDict(extra="forbid")
    outcome: Literal["authorize_broader_production", "hold", "reject_progression"]
    confirm_decision: bool
    note: str = Field(min_length=10, max_length=4000)


class AIBroaderProductionDocumentCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
    claim_id: UUID
    document_id: UUID
    ...
    change_ticket_reference: str = Field(min_length=8, max_length=500)
    note: str = Field(min_length=10, max_length=4000)
    confirm_new_broader_production_eligibility: bool


class AIBroaderProductionRunOutcome(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AIBroaderProductionMonitorCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AIBroaderProductionIncidentCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AIBroaderProductionIncidentResolve(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AIBroaderProductionLifecycle(BaseModel):
    model_config = ConfigDict(extra="forbid")
    confirm: bool
    note: str = Field(min_length=10, max_length=4000)
...
class AIBroaderProductionApprovalResponse(_ORMResponse):
    id: UUID
...
class AIBroaderProductionDocumentResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
    claim_id: UUID
    document_id: UUID
...
class AIBroaderProductionRunResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
    eligibility_id: UUID
    claim_id: UUID
...
class AIBroaderProductionMonitorResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
...
class AIBroaderProductionIncidentResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
...
class AIBroaderProductionResponse(BaseModel):
    id: UUID
    readiness_assessment_id: UUID
    ...
    inherited_outcome_assessment_hash: str
    inherited_outcome_decision_hash: str
    model: str
    ...
    revoked_at: datetime | None
    revocation_note: str | None
    approvals: list[AIBroaderProductionApprovalResponse]
    document_eligibility: list[AIBroaderProductionDocumentResponse]
    runs: list[AIBroaderProductionRunResponse]
    monitors: list[AIBroaderProductionMonitorResponse]
    incidents: list[AIBroaderProductionIncidentResponse]
    summary: dict
    created_at: datetime


class AIBroaderProductionDashboard(BaseModel):
    authorizations: list[AIBroaderProductionResponse]
