...
def require_external_ai_runtime_authorization(
    ...
    Sprint 11P takes precedence over Sprint 11N, Sprint 11K, Sprint 11I and
    Sprint 11G. Once a tenant has any 11P attempt, inactive/held/paused/
    revoked/completed/expired 11P state blocks execution rather than falling
    back to an older Production authorization.
    """
