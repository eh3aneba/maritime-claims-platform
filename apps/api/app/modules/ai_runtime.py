...
def require_external_ai_runtime_authorization(
    ...
    Sprint 11N takes precedence over Sprint 11K, Sprint 11I and Sprint 11G.
    Once a tenant has any 11N attempt, inactive/held/paused/revoked/completed/
    expired 11N state blocks execution rather than falling back to an older
