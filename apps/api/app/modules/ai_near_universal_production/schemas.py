...
class AINearUniversalCreate(BaseModel):
    ...
    rollout_percentage: int = Field(ge=91, le=99)
    max_claims: int = Field(ge=1, le=150)
    max_documents: int = Field(ge=1, le=450)
    max_users: int = Field(ge=1, le=150)
    ...
    confirm_separate_near_universal: bool


class AINearUniversalApprovalWrite(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AINearUniversalDecision(BaseModel):
    model_config = ConfigDict(extra="forbid")
    outcome: Literal["authorize_near_universal_91_99_cohort", "hold_for_remediation", "reject_progression"]
    confirm_decision: bool
    note: str = Field(min_length=10, max_length=4000)


class AINearUniversalDocumentCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
    claim_id: UUID
    document_id: UUID
    ...
    change_ticket_reference: str = Field(min_length=8, max_length=500)
    note: str = Field(min_length=10, max_length=4000)
    confirm_new_near_universal_eligibility: bool


class AINearUniversalRunOutcome(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AINearUniversalMonitorCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AINearUniversalIncidentCreate(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AINearUniversalIncidentResolve(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class AINearUniversalLifecycle(BaseModel):
    model_config = ConfigDict(extra="forbid")
    confirm: bool
    note: str = Field(min_length=10, max_length=4000)
...
class AINearUniversalApprovalResponse(_ORMResponse):
    id: UUID
...
class AINearUniversalDocumentResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
    claim_id: UUID
    document_id: UUID
...
class AINearUniversalRunResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
    eligibility_id: UUID
    claim_id: UUID
...
class AINearUniversalMonitorResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
...
class AINearUniversalIncidentResponse(_ORMResponse):
    id: UUID
    authorization_id: UUID
...
class AINearUniversalResponse(BaseModel):
    id: UUID
    outcome_assessment_id: UUID
    final_production_authorization_id: UUID
    requested_by_id: UUID | None
    ...
    revoked_at: datetime | None
    revocation_note: str | None
    approvals: list[AINearUniversalApprovalResponse]
    document_eligibility: list[AINearUniversalDocumentResponse]
    runs: list[AINearUniversalRunResponse]
    monitors: list[AINearUniversalMonitorResponse]
    incidents: list[AINearUniversalIncidentResponse]
    summary: dict
    created_at: datetime


class AINearUniversalDashboard(BaseModel):
    authorizations: list[AINearUniversalResponse]
