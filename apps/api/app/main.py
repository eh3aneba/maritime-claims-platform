...
from app.modules.documents.recovery_authoritative_storage_ownership_health_router import router as recovery_authoritative_storage_ownership_health_router
from app.modules.documents.recovery_authoritative_storage_ratification_authorization_router import router as recovery_authoritative_storage_ratification_authorization_router
from app.modules.documents.recovery_authoritative_storage_ratification_execution_router import router as recovery_authoritative_storage_ratification_execution_router
from app.modules.documents.recovery_durable_authoritative_storage_health_router import router as recovery_durable_authoritative_storage_health_router
...
from app.modules.documents.recovery_dual_write_rehearsal_authorization_router import router as recovery_dual_write_rehearsal_authorization_router
from app.modules.documents.recovery_dual_write_rehearsal_execution_router import router as recovery_dual_write_rehearsal_execution_router
from app.modules.documents.recovery_dual_write_rehearsal_health_router import router as recovery_dual_write_rehearsal_health_router
from app.modules.documents.recovery_durable_read_health_router import router as recovery_durable_read_health_router
from app.modules.documents.recovery_durable_read_reauthorized_renewal_health_router import router as recovery_durable_read_reauthorized_renewal_health_router
from app.modules.documents.recovery_durable_read_reauthorized_renewal_routing_router import router as recovery_durable_read_reauthorized_renewal_routing_router
...
from app.modules.documents.recovery_durable_write_ownership_authorization_router import router as recovery_durable_write_ownership_authorization_router
from app.modules.documents.recovery_durable_write_ownership_execution_router import router as recovery_durable_write_ownership_execution_router
from app.modules.documents.recovery_durable_write_ownership_health_router import router as recovery_durable_write_ownership_health_router
from app.modules.documents.recovery_read_ownership_transition_authorization_router import router as recovery_read_ownership_transition_authorization_router
from app.modules.documents.recovery_read_ownership_transition_health_router import router as recovery_read_ownership_transition_health_router
from app.modules.documents.recovery_read_ownership_transition_routing_router import router as recovery_read_ownership_transition_routing_router
from app.modules.documents.recovery_read_path_cutover_router import router as recovery_read_path_cutover_router
from app.modules.documents.recovery_routable_dual_write_canary_authorization_router import router as recovery_routable_dual_write_canary_authorization_router
from app.modules.documents.recovery_routable_dual_write_canary_execution_router import router as recovery_routable_dual_write_canary_execution_router
from app.modules.documents.recovery_routable_dual_write_canary_health_router import router as recovery_routable_dual_write_canary_health_router
from app.modules.documents.recovery_write_ownership_transition_authorization_router import router as recovery_write_ownership_transition_authorization_router
from app.modules.documents.recovery_write_ownership_transition_execution_router import router as recovery_write_ownership_transition_execution_router
from app.modules.documents.recovery_write_ownership_transition_health_router import router as recovery_write_ownership_transition_health_router
...
app.include_router(recovery_durable_read_reauthorized_renewal_routing_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_durable_read_reauthorized_renewal_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_read_ownership_transition_authorization_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_read_ownership_transition_routing_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_read_ownership_transition_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_dual_write_rehearsal_authorization_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_dual_write_rehearsal_execution_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_dual_write_rehearsal_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_routable_dual_write_canary_authorization_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_routable_dual_write_canary_execution_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_routable_dual_write_canary_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_write_ownership_transition_authorization_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_write_ownership_transition_execution_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_write_ownership_transition_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_durable_write_ownership_authorization_router, prefix=settings.api_v1_prefix)
...
app.include_router(recovery_authoritative_storage_ownership_health_router, prefix=settings.api_v1_prefix)
app.include_router(recovery_authoritative_storage_ratification_authorization_router, prefix=settings.api_v1_prefix)
