    ...
    <div>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <aside className="space-y-5">
          ...
          <section className="panel p-5"><h2 className="text-sm font-semibold text-slate-950">Pilot Operations</h2><p className="mt-1 text-xs leading-5 text-slate-500">Review deployment gates, content-free monitoring, incidents, governance and a manifest-only pilot exit.</p><Link href={`/claims/${claim.id}/pilot-operations`} className="secondary-button mt-4 w-full justify-center">Open pilot operations</Link></section>
