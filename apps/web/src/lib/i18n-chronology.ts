...
const en = {
  ...
  "staleConflictError": "This conflict changed after you loaded it. Your note is preserved. Refresh the current state and review the evidence again before submitting.",
  "stateUnavailable": "The current conflict state token is unavailable. Refresh the chronology before recording a decision.",
  "refreshCurrentState": "Refresh current state",
  ...
  "section.conflictsHelp": "A conflict is a review flag, not a finding about which evidence is true. Decisions are tied to the exact evidence state and retained as append-only history.",
  "conflictSeverity": "Conflict severity: {value}",
  "difference": "Difference",
  "minutes": "minutes",
  "sourceSide": "Source {side}",
  "sourceLocator": "Source locator",
  "sourceUnavailable": "No linked source detail is available for this side.",
  ...
  "currentDisposition": "Current human disposition",
  "decisionHistory": "Decision history ({count})",
  "noDecisionHistory": "No human decision has been recorded for this conflict state yet.",
  "deliberateReReview": "Begin deliberate re-review",
  "reReviewWarning": "You are deliberately re-reviewing an already reviewed conflict. Submitting will append a new human decision; it will not erase prior decision history.",
  "cancelReReview": "Cancel re-review",
  "state.none": "No decision",
  "state.current": "Decision current",
  "state.stale": "Prior decision stale",
...
const fa: Record<ChronologyKey, string> = {
  ...
  "staleConflictError": "این تعارض پس از بارگذاری شما تغییر کرده است. یادداشت شما حفظ شده؛ وضعیت فعلی را به‌روزرسانی کنید و پیش از ارسال دوباره شواهد را بازبینی کنید.",
  "stateUnavailable": "توکن وضعیت فعلی تعارض در دسترس نیست. پیش از ثبت تصمیم، خط زمانی را به‌روزرسانی کنید.",
  "refreshCurrentState": "به‌روزرسانی وضعیت فعلی",
  ...
  "section.conflictsHelp": "تعارض فقط یک پرچم بازبینی است و به معنی تشخیص درست بودن یکی از شواهد نیست. هر تصمیم به وضعیت دقیق شواهد متصل می‌شود و تاریخچه آن به‌صورت افزایشی حفظ می‌شود.",
  "conflictSeverity": "شدت تعارض: {value}",
  "difference": "اختلاف",
  "minutes": "دقیقه",
  "sourceSide": "منبع {side}",
  "sourceLocator": "محل منبع",
  "sourceUnavailable": "برای این سمت جزئیات منبع لینک‌شده در دسترس نیست.",
  ...
  "currentDisposition": "تصمیم انسانی فعلی",
  "decisionHistory": "تاریخچه تصمیم‌ها ({count})",
  "noDecisionHistory": "هنوز برای این وضعیت تعارض تصمیم انسانی ثبت نشده است.",
  "deliberateReReview": "شروع بازبینی مجدد آگاهانه",
  "reReviewWarning": "شما در حال بازبینی مجدد آگاهانه یک تعارض قبلاً بررسی‌شده هستید. ارسال، یک تصمیم انسانی جدید به تاریخچه اضافه می‌کند و تصمیم‌های قبلی را حذف نمی‌کند.",
  "cancelReReview": "لغو بازبینی مجدد",
  "state.none": "بدون تصمیم",
  "state.current": "تصمیم فعلی است",
  "state.stale": "تصمیم قبلی قدیمی شده",
